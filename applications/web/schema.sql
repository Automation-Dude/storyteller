...
CREATE TRIGGER home_section_update_trigger AFTER
...
CREATE INDEX idx_home_section_user ON home_section (user_id);
...
CREATE TRIGGER koreader_user_update_trigger AFTER
...
CREATE TRIGGER koreader_progress_update_trigger AFTER
...
CREATE TRIGGER koreader_document_update_trigger AFTER
